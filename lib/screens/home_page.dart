...
import 'package:flutter_video_player/screens/details_page.dart';
                  ...
                  onTap: () {
                    Get.to(
                      () => DetailsPage(
                        ...
                        thumbnail: snap[index].thumbnail,
                        views: snap[index].viewers,
                        channelImage: snap[index].channelImage,
                        channelName: snap[index].channelName,
                        subscribers: snap[index].channelSubscriber,
                        videoUrl: snap[index].manifest,
                      ),
                    );
                  },
                  child: Card(
                        ...
                        ListTile(
                          ...
                          leading: CircleAvatar(
                            ...
                            backgroundImage: NetworkImage(
                                snap[index].channelImage.toString()),
                          ),
                          title: Text(
